    ...
    return (
        <div className="flex-col justify-center px-4">
            ...
            <p className="mt-10 text-gray-400 text-sm">
                We willen graag weten waar je mee van dienst kunnen zijn. Je
                kunt ons bereiken via de wegen die hieronder beschreven staan,
                maar je kunt ook links hier van een bericht achterlaten en dan
                nemen we zo snel mogelijk contact met u op.
            </p>
